...
$RootPath=(get-childitem $HOME -recurse | Where-Object {$_.PSIsContainer -eq $true -and $_.Name -match "^FluentDash11$" -and $_.FullName -match "Rainmeter\\Skins\\FluentDash"}).FullName
